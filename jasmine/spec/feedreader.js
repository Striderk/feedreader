...
$(function () {
    ...
    describe('RSS Feeds', function () {
         ...
         */
        it('has name defined and not null', function () {
            for (var i = 0; i < allFeeds.length; i++) {
    ...
    describe("New Feed Selection", function () {
        var feed, newFeed;
        //load feed before testing spec
        beforeEach(function (done) {

            loadFeed(0, function () {
                feed = $('.header-title').html();
                //to meet async function demands
                loadFeed(1, function () {
         ...
         */
        //check for newFeed at reload
        it('new feed at reload', function () {
